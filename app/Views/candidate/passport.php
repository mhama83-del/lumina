...
<section class="section" style="padding-top:6px">
  ...
  <div class="grid grid-3">
    <div class="card">
      ...
      <p class="muted" style="font-size:11px;text-align:center;margin-top:8px">40% coverage · 25% evidence · 20% activity · 15% pace</p>
      <div class="row" style="justify-content:center;margin-top:8px">
...
<aside class="drawer" id="whyDrawer" aria-label="Why this score">
  ...
  <p class="muted" style="font-size:12px">Points = component &times; weight; they add up to your readiness. Every component is 0–100.</p>
