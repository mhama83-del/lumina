...
<?php helper('ui'); ?>
<section class="hero">
  <div class="section-label">University · Intervention Plan</div>
  <h1>Targeted actions that move the number.</h1>
  ...
  <div class="row" style="margin-top:12px"><a class="btn btn-ghost" href="<?= base_url('university') ?>">← Back to dashboard</a></div>
</section>
